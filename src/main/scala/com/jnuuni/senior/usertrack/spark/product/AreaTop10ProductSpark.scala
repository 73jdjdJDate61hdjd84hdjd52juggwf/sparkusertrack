package com.jnuuni.senior.usertrack.spark.product
...
import com.jnuuni.senior.usertrack.spark.util.{SQLContextUtil, SparkConfUtil, SparkContextUtil}
import com.jnuuni.senior.usertrack.util.ParamUtils
...
object AreaTop10ProductSpark {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 自定义UDF
    def isEmpty(str: String): Boolean = str == null || str.trim.isEmpty || "null".equalsIgnoreCase(str.trim)

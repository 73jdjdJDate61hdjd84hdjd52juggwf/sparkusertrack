package com.jnuuni.senior.usertrack.spark.util

import com.alibaba.fastjson.{JSONArray, JSONObject}
import com.jnuuni.senior.usertrack.spark.session.UserVisitSessionRecord
import com.jnuuni.senior.usertrack.util.NumberUtils
